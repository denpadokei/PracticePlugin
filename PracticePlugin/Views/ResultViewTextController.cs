...
namespace PracticePlugin.Views
{
    ...
    public class ResultViewTextController : BSMLAutomaticViewController, IInitializable, IDisposable
    {
        ...
        {
            var bottomPanel = this._resultsViewController.gameObject.GetComponentsInChildren<Transform>().FirstOrDefault(x => x.name == "BottomPanel");
            BSMLParser.Instance.Parse(Utilities.GetResourceContent(Assembly.GetExecutingAssembly(), this.ResourceName), bottomPanel.gameObject, this);
        }
        #endregion
        //ﾟ+｡*ﾟ+｡｡+ﾟ*｡+ﾟ ﾟ+｡*ﾟ+｡｡+ﾟ*｡+ﾟ ﾟ+｡*ﾟ+｡*ﾟ+｡｡+ﾟ*｡+ﾟ ﾟ+｡*ﾟ+｡｡+ﾟ*｡+ﾟ ﾟ+｡*ﾟ+｡*ﾟ+｡｡+ﾟ*｡+ﾟ ﾟ+｡*ﾟ+｡｡+ﾟ*｡+ﾟ ﾟ+｡*
        #region // プライベートメソッド
        ...
        {
            this.FailText = this._songTimeInfoEntity.ShowFailTextNext && PluginConfig.Instance.ShowTimeFailed ? this._songTimeInfoEntity.FailTimeText : "";
